    ...
    public partial class updateTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FunID = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Funtion", x => x.FunID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LangueId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LangName = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    IsDefault = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Language", x => x.LangueId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryTranslation", x => new { x.LangueId, x.CategoryId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_CategoryTranslation_Language_LangueId",
                        column: x => x.LangueId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductTranslation", x => new { x.LangueId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_ProductTranslation_Language_LangueId",
                        column: x => x.LangueId,
                        principalTable: "Language",
                        principalColumn: "LangueId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Promotion", x => x.ProId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    GetUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Order", x => x.OrderId);
                    table.ForeignKey(
                        name: "FK_Order_Users_GetUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SystemActivities_Funtion_FuntionId",
                        column: x => x.FuntionId,
                        principalTable: "Funtion",
                        principalColumn: "FunID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SystemActivities_Users_UsersId",
                        column: x => x.UsersId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                table: "AppConfig",
                columns: new[] { "Key", "Keys", "Value" },
                values: new object[] { 1, "HomePage", "This is HomePage" });

            migrationBuilder.InsertData(
                table: "AppConfig",
                columns: new[] { "Key", "Keys", "Value" },
                values: new object[] { 2, "ContactPage", "This is ContactPage" });

            migrationBuilder.InsertData(
                table: "AppConfig",
                columns: new[] { "Key", "Keys", "Value" },
                values: new object[] { 3, "InfomationPage", "This is InfomationPage" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SystemActivities_FuntionId",
                table: "SystemActivities",
                column: "FuntionId");

            migrationBuilder.CreateIndex(
                name: "IX_SystemActivities_UsersId",
                table: "SystemActivities",
                column: "UsersId");
